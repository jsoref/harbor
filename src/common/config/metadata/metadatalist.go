...
type Item struct {
	...
	// email, ldapbasic, ldapgroup, uaa settings, used to retrieve configure items by group
...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.OIDCExtraRedirectParams, Scope: UserScope, Group: OIDCGroup, DefaultValue: "{}", ItemType: &StringToStringMapType{}},
